# guardian-score-simulacion-client-java[![GitHub Packages](https://img.shields.io/badge/Maven&nbsp;package-Last&nbsp;version-lemon)](https://github.com/orgs/APIHub-CdC/packages?repo_name=guardian-score-simulacion-client-java) 

<p>Esta API Ordena las solicitudes de crédito de acuerdo a la probabilidad de ser un posible fraude. (entorno de simulación).<br/><img src='https://github.com/APIHub-CdC/imagenes-cdc/blob/master/circulo_de_credito-apihub.png' height='37' width='160'/></p><br/>
...
En el archivo GuardIAnScoreApiTest.java, que se encuentra en ***src/test/java/io/GuardianScoreSimulacion/client/api/***. Se deberá modificar los datos de la petición y los datos de consumo:
